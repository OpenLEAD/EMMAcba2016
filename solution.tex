...
through the use of the normal vector at each point, by exploiting the fact that
the center of the sphere is in the direction of the normal, thus reducing to two
the number of assigned voxels per point.
