...
the matrix of links' masses and moments of inertia estimated by manipulator's
...
matrix \cite{hourtash2005kinematic}, $\ddot{X}$ is the linear accelerations, and $J$
is the Jacobian matrix. Therefore, torques can be analytically estimated by
