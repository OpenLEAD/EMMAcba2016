...
diversify the normal vectors' directions \cite{Rusinkiewicz2001}. This approach
reduces the number of samples, lowering the computional cost, besides a
subsampling of the point clouds is perfomed due to the high density provided by
the sensor.
