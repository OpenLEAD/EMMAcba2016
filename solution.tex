...
the robot nor the positioning of the blade can be considered as known.
Therefore, in EMMA's context, calibrating the system is identifing the robot
and the blade and estimate its poses in respect to the environment. To gather
tridimensional information about the turbine's environment, a laser scanner is
placed inside the hydraulic circuit and the pose estimation is divided in:
localization of the robot, and localization of the blade.
...
The pose estimation of the blade can not be assisted with the introduction of
