...
transform method \cite{camurri20143d}. The 3D Hough
transform is the search of the object in the parametric space. A
sphere has a four dimensional parameter space, tree for the position of its center and one for its radius. For each point on the point
